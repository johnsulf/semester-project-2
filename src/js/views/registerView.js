  ...
  app.innerHTML = `
        <section>
            ...
            <form id="register-form" class="mt-4">
                <input type="email" placeholder="Email" class="border p-2 mb-4 w-full" required>
                <input type="password" placeholder="Password" class="border p-2 mb-4 w-full" required>
